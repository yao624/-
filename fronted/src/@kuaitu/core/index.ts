...
export { default as DynamicVariablePlugin } from './plugin/DynamicVariablePlugin';
...
// Re-export dynamic variable types
export type { DynamicConfig, DynamicVariable } from './interface/Editor';
