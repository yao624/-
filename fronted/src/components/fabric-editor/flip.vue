    ...
    <div class="bg-item">
      <Tooltip :content="$t('attrSeting.flip.x')">
        <Button long @click="flip('X')" type="text">
          <img :src="flipX" width="14" height="14" alt="flipX" />
        </Button>
      </Tooltip>
      <Tooltip :content="$t('attrSeting.flip.y')">
        <Button long @click="flip('Y')" type="text">
          <img :src="flipY" width="14" height="14" alt="flipY" />
        </Button>
      </Tooltip>
    </div>
...
import flipX from '@/assets/icon/flip/x.svg?url';
import flipY from '@/assets/icon/flip/y.svg?url';
