...
// 左侧组件
import importTmpl from '@/components/fabric-editor/importTmpl.vue';
import fontStyle from '@/components/fabric-editor/fontStyle.vue';
import myMaterial from '@/components/fabric-editor/myMaterial/index.vue';
import tools from '@/components/fabric-editor/tools.vue';
import material from '@/components/fabric-editor/material.vue';
import layer from '@/components/fabric-editor/layer.vue';
