<template>
  <page-container :title="t('pages.dashboard.workplace.title')">
    <template #content>
      <div class="page-header-content">
        ...
        <div class="content">
          <div class="content-title">
            早安，
            <span class="text-red">{{ currentUser.nickname }}</span>
      ...
      <a-row :gutter="24">
        <a-col :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
          ...
          >
            ...
            >
              <a-card :bordered="false" style="box-shadow: none" :body-style="{ padding: 0 }">
                <a-card-meta>
                  <template #title>
        ...
        <a-col style="padding: 0 12px" :xl="8" :lg="24" :md="24" :sm="24" :xs="24">
          ...
          >
            <div style="min-height: 400px">
              ...
              <radar-vue :data="radar.dataSource" :height="350" />
            </div>
          </a-card>
...
import RadarVue from './components/radar/index.vue';
