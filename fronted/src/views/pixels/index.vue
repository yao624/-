<template>
  <page-container :title="t('pages.pixels.title')">
    <a-card mb-4>
      <a-row :gutter="[15, 0]" v-if="expand">
        <a-col :span="6">
          <a-form-item :label="t('pages.pixels.pixel')">
            <a-input v-model:value="pagination.pixel" />
          </a-form-item>
        </a-col>
        <a-col :span="6">
...
import { queryFB_PixelsApi, updateFB_PixelsOneApi } from '@/api/fb_pixels';
  ...
  setup() {
    ...
    const columns = computed<any[]>(() => {
      ...
      return [
        ...
        {
          title: t('pages.pixels.is.unavailable'),
