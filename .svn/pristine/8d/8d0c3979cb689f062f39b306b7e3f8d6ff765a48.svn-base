...
class FbCampaign extends BaseModel
{
    ...
    {
        return $this->hasMany(Click::class, 'fb_campaign_source_id', 'source_id');
    }

    public function offerConversions()
    {
        return $this->hasMany(Conversion::class, 'fb_campaign_source_id', 'source_id');
    }

    public function insights()
    {
        return $this->hasMany(FbCampaignInsight::class, 'campaign_id', 'source_id');
    }
    ...
    {
        return $this->hasMany(FbPagePost::class, 'campaign_source_id', 'source_id');
    }

    public function adLogs()
    {
        return $this->belongsToMany(AdLog::class, 'adlog_campaign', 'campaign_source_id', 'adlog_id', 'source_id', 'id')
            ->withPivot(['campaign_created', 'campaign_failed_reason']);
    }
