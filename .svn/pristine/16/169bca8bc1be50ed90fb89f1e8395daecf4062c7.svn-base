<template>
  <a-modal
    :title="t('pages.common.tags.title')"
    :open="visible"
    :width="600"
  ...
  >
    <a-spin :spinning="loading">
      <a-form :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-form-item :label="t('pages.common.tags.action')">
          <a-radio-group v-model:value="modelRef.action" button-style="solid">
            <a-radio-button value="add">{{ t('pages.common.tags.action.add') }}</a-radio-button>
            <a-radio-button value="delete">
              {{ t('pages.common.tags.action.remove') }}
            </a-radio-button>
          </a-radio-group>
        </a-form-item>
        <a-form-item label="tags">
          <a-select
            ...
            mode="tags"
            style="width: 100%"
            :placeholder="t('pages.common.tags.modal.placeholder')"
          >
