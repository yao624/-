  ...
  <div class="main user-layout-register">
    ...
    <a-form id="formRegister" layout="vertical">
      <a-form-item v-bind="validateInfos.email">
        <a-input size="large" type="text" placeholder="邮箱" v-model:value="modelRef.email" />
      </a-form-item>
      <a-popover
        placement="rightTop"
        :trigger="['focus']"
      ...
      <a-form-item v-bind="validateInfos.password2">
        <a-input-password size="large" placeholder="确认密码" v-model:value="modelRef.password2" />
      </a-form-item>

      <a-form-item v-bind="validateInfos.mobile">
        <a-input size="large" placeholder="11 位手机号" v-model:value="modelRef.mobile">
