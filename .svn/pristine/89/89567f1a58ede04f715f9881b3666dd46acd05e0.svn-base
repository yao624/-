...
class ActionCopyFbObjectSync implements ShouldQueue
{
    ...
    private $object_type;
    private $count;
    public function __construct(string $item_source_id, $object_type)
    {
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $endpoint = "https://graph.facebook.com/{$version}/{$this->item_source_id}/copies";
            $query = null;
            $body = [
                'deep_copy' => true
            ];
