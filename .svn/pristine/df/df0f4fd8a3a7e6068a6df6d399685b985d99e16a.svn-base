export default {
  ...
  'pages.rule.title': 'Rules',
  'pages.operator.title': 'Operator',
  'pages.expense.title': 'Expense',
  'pages.networks.title': 'Networks',
  'pages.links.title': 'Links',
  'pages.proxies.title': 'Proxies',
  'pages.agents.title': 'Agents',
  'pages.copywritings.title': 'Copywriting',
  'pages.accounts.title': 'Facebook Account',
  'pages.pages.title': 'Pages',
  'pages.adaccounts.title': 'Ad Account',
  'pages.business.manager.title': 'Business Manager',
  'pages.campaigns.title': 'Campaign',
  'pages.pixels.title': 'Pixels',
  'pages.clicks.title': 'Clicks',
  'pages.conversions.title': 'Conversion',
  'pages.form.title': 'Form',
  'pages.materials.title': 'Materials',
  ...
  'pages.system.audit.title': 'Audit',
  ...
  'pages.resource.title': 'Resource',
  'pages.adhistory.title': 'Ad History',
  'pages.convp.title': 'Performance',

  'pages.virtual.card.title': 'Cards',
  'pages.cards.title': 'Cards',
  'pages.transactions.title': 'Transactions',

  'pages.creative.title': 'Creative',
  'pages.miscellaneous.title': 'Misc',
  'pages.comment.helper.title': 'Comment Helper',

  // Ad related
  'pages.adTemplate.title': 'Ad Template',
  'pages.mediaMaterialLibrary.title': 'Media Material Library',
  'pages.materialEditor.title': 'Material Editor',
